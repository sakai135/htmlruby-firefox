...
var Preferences = {
	...
	toString: function() {
		return 'version:' + VERSION + '; rubyTextSize:' + this.rubyTextSize + '; spaceRubyText:' + this.spaceRubyText + '; processInsertedContent:' + this.processInsertedContent + '; rubyLineHeight:' + this.rubyLineHeight + '; adjustLineHeight:' + this.adjustLineHeight + ';';
	}
};
